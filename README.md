...
In this project, I utilized **Informatica PowerCenter** to tackle real-world data engineering challenges with a strong focus on **Extraction, Transformation, and Loading (ETL)**. The solution processes customer churn data from two CSV files: `Churn_Modelling1.csv` and `Churn_Modelling2.csv`, applies business rules, ensures data quality, and produces analytical outputs suitable for reporting and decision-making.
